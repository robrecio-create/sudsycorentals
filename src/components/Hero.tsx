          ...
          >
            ...
            <div className="relative">
              ...
              <motion.div
                ...
                className="absolute -top-4 -right-4 md:top-0 md:right-0 bg-accent text-accent-foreground rounded-full w-28 h-28 flex flex-col items-center justify-center shadow-xl"
              >
